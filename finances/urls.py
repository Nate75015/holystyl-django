...
urlpatterns = [
    ...
    path("facturation/coordonnees/", views.coordonnees, name="coordonnees"),
    path("logos/", views.logos, name="logos"),
    path("logos/ajouter/", views.logo_ajouter, name="logo_ajouter"),
    path("logos/<int:pk>/modifier/", views.logo_modifier, name="logo_modifier"),
    path("logos/<int:pk>/supprimer/", views.logo_supprimer, name="logo_supprimer"),
